...
const Contact = () => {
  return (
    <>
      <Helmet>
        <title>Kontakt & Termin | Vip Haircut Aachen</title>
        <meta 
          name="description" 
          content="Kontaktieren Sie Vip Haircut in Aachen. Vereinbaren Sie Ihren Termin über unseren Chatbot oder rufen Sie uns an. Mo-Fr 09-18:30 Uhr, Sa 09-16 Uhr." 
        />
        <link rel="canonical" href="https://viphaircut.de/kontakt" />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Barbershop",
            "@id": "https://viphaircut.de/#barbershop",
            "name": "Vip Haircut Aachen",
            "url": "https://viphaircut.de",
            "logo": "https://viphaircut.de/images/logo.png",
            "image": "https://viphaircut.de/images/shop.jpg",
            "telephone": "015734980998",
            "priceRange": "€€",
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "Aachener Str. 155",
            ...
            "sameAs": [
              "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d20126.531085360584!2d6.169486834765627!3d50.908613500000016!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c0a18743927a6f%3A0x5c4358546ccda8db!2zQmFyYmVyIFNob3AgJkZyaXNldXIg2LXYp9mE2YjZhiDYrdmE2KfZgtip!5e0!3m2!1sde!2sde!4v1770329873702!5m2!1sde!2sde",
              ...
              <AnimateOnScroll animation="slide-right" className="order-2 lg:order-2">
                <div className="space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a 
                          href="mailto:info@viphaircut.de" 
                          className="text-muted-foreground hover:text-primary transition-colors"
                        >
                          info@viphaircut.de
                        </a>
                  ...
                  <div className="aspect-video rounded-sm overflow-hidden border border-border mt-8">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d20126.531085360584!2d6.169486834765627!3d50.908613500000016!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c0a18743927a6f%3A0x5c4358546ccda8db!2zQmFyYmVyIFNob3AgJkZyaXNldXIg2LXYp9mE2YjZhiDYrdmE2KfZgtip!5e0!3m2!1sde!2sde!4v1770329873702!5m2!1sde!2sde"
                      width="100%"
                      height="100%"
                      ...
                      title="Standort Vip Haircut Aachen"
                    />
                  </div>
                </div>
              </AnimateOnScroll>
